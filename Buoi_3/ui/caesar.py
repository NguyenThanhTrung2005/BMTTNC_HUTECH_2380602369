...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QtCore.QRect(30, 300, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.textPlainText = QtWidgets.QTextEdit(self.centralwidget)
        self.textPlainText.setGeometry(QtCore.QRect(160, 70, 421, 41))
        ...
        self.pushDecrypt.setGeometry(QtCore.QRect(290, 350, 111, 41))
        self.pushDecrypt.setObjectName("pushDecrypt")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(160, 410, 258, 19))
        font = QtGui.QFont()
        font.setPointSize(12)
